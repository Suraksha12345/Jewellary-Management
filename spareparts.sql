...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 08, 2023 at 01:02 PM
...
(1, 'Yathiraj', 'yathirajshtt@gmail.com', 'Yathiraj@123', '8951137153'),
...
(2, 'Wiper Blade', 2000, 'Its primary function is to clear water, snow,  dirt and other debris from the windshield , improving visibility for the driver.', 'wiper blade.jpg', '', '', ''),
(3, 'Ball Bearing', 1800, 'They are small, spherical-shaped metal balls that reduce friction and enable smooth rotation between two surfaces.', 'ball bearing.jpg', '', '', ''),
(4, 'Alternator Pulley', 800, 'It plays a crucial role in driving the alternator and converting mechanical energy into electrical energy.', 'Alternater pulley.jpg', '', '', ''),
(5, 'Bonnet Lid', 2200, 'an exterior component of a car that covers and provides access to the engine compartment. It is typically located at the front of the vehicle and is hinged at the rear, allowing it to be raised and secured in an open position for engine maintenance or inspection.', 'Bonnet Lid.jpg', '', '', ''),
(6, 'Air filter', 590, 'Its primary function is to filter out contaminants and debris from the incoming air before it reaches the engine.', 'air filter.jpg', '', '', ''),
(7, 'Oil filter', 289, 'Its main function is to remove impurities and contaminants from the engine oil, ensuring that the oil remains clean and free from debris.', 'oil filter.jpg', '', '', ''),
(8, 'Alloy wheels', 5100, 'Alloy wheels, also known as aluminum wheels or alloy rims, are a popular type of wheel used in automobiles. They are made from a combination of metals, typically aluminum or magnesium, blended with other elements to enhance their strength, durability, and appearance.', 'Alloy wheels.jpg', '', '', ''),
(10, 'Master Kit', 2500, 'The master cylinder, also known as the master brake cylinder, converts the pressure on the brake pedal to hydraulic pressure by feeding brake fluid into the brake circuit and controlling this according to the mechanical force. Master brake cylinders are used both in disc brakes and drum brakes.', 'master-cylinder-500x500.webp', '', '', ''),
(11, 'Brake Rotor', 7500, 'Brake rotors in cars are circular metal discs connected to the wheels. There are four brake rotors installed in cars, one for each wheel. The rotors’ primary purpose is to slow down the turning of the car’s wheels by utilizing friction.', 'rotors.jpeg', '', '', ''),
(12, 'Brake pad', 1200, 'Brake pads are a component of disc brakes used in automotive and other applications. Brake pads are steel backing plates with friction material bound to the surface that faces the disk brake rotor. Brake pads convert the kinetic energy of the car to thermal energy by friction.', 'brkpad(1).jpeg', '', '', ''),
...
(14, 'Headlight bulb', 3600, 'A headlamp is a lamp attached to the front of a vehicle to illuminate the road ahead. Headlamps are also often called headlights, but in the most precise usage, headlamp is the term for the device itself and headlight is the term for the beam of light produced and distributed by the device.', 'download (1).jpeg', '', '', ''),
(15, 'Windshield', 5500, 'The windshield for cars is typically made of laminated glass or safety glass. Laminated glass is a sandwich of two panes of glass with a polyvinyl butyral (PVB) interlayer in between which is then bonded together to form a single uniform piece for windshield safety.', 'car-windshield-glass-250x250.webp', '', '', ''),
...
(17, 'Radiator', 2200, 'A radiator is the key component of the engine\'s cooling system. Its main role is to disperse a mix of antifreeze and water throughout its fins, which releases some of the engine\'s heat while taking in cool air before continuing to pass the rest of the engine.', 'Automobile_radiator.jpg', '', '', ''),
(18, 'Condensor', 17500, 'The condenser is a heat exchanger. It is located at the front of the vehicle. The condenser cools down the refrigerant (heated up by the compressor) and becomes a liquid (condensates) by transferring its heat to the flow of ambient air passing through it.', 'car-ac-condenser-500x500.webp', '', '', ''),
(19, 'Drive shaft', 1599, 'The drive shaft (also called propeller shaft or prop shaft) is a component of the drive train in a vehicle, with the purpose of delivering torque from the transmission to the differential, which then transmits this torque to the wheels in order to move the vehicle.', 'download (2).jpeg', '', '', ''),
(21, 'Clutch Assembly', 19999, 'A clutch is a mechanical device that allows the output shaft to be disconnected from the rotating input shaft. The clutch\'s input shaft is typically attached to a motor, while the clutch\'s output shaft is connected to the mechanism that does the work.', 'clutch-assembly-part.jpg', '', '', ''),
(22, 'Timing Chain', 25000, 'A timing chain is an internal engine component that\'s fitted to synchronise the rotation of the camshaft and the crankshaft — these two elements are essential for driving the wheels. The movement of the chain allows for engine cylinders to produce power to operate and propel the vehicle.', 'bike-timing-chain-kit.jpg', '', '', ''),
...
(6, 'Oil filter', '', '', 0, 289, 2, 578, 'tejas', 's', 'sahana@gmail.com', '9856674724', 'managalore', 'pending', 0),
